...
The second step is to build the contrast vector for your hypothesis. In this example, we want to test whether the log(FC) of *X1* and *cccontrol* are equal for the first gene. This hypothesis leads to the contrast vector ```(0 1 -1 0)```. Thus, the test can be performed
